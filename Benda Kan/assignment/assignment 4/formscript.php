...
<head>
	<meta charset="UTF-8">
	<title>ITMD-461 Assignment 3 From Processing Script</title>
		<style>
		.box {
...
<body>
	<div style="text-align:center;">
		<h2>ITMD-461 Assignment 3 From Processing Script</h2>
		<p>This page will display the results of the form that was submitted to it.</p>
	</div>
	<hr><br>
	<h1>Thank you for your ITMD-461 form submission, <?php echo htmlentities($firstName) ?>!</h1>
	<div class="box">
